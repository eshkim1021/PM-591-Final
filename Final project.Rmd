...
The data itself is very unbalanced, with 184,598 patients that were successfully discharged compared to the 3,412 that died in the hospital. This could lead to an optimistically low misclassification error. Therefore, balanced random forests will be used to help balance the two binary outcomes. 
...
#dat_CVlasso <- cv.glmnet(x,y,family = "gaussian",alpha = 1)
...
```{r, echo = FALSE}
plot(roc_glm_train, lty = 2, lwd = 2, col = 'red4',cex.axis = 1.3, cex.lab = 1.3)
lines(roc_glm_test,lty = 2, lwd = 2, col = 'blue4', cex.axis = 1.3, cex.lab = 1.3)
legend("bottomright", legend = c("Train","Test"), col = c('red4','blue4'),lty = 2)
title(main = "ROC Curve for Patient Mortality (Logistic Regression)")
```
...
```{r, echo = FALSE}
plot(rf_roc_train,lwd = 2, col = 'red4',cex.axis = 1.3, cex.lab = 1.3)
lines(rf_roc_test, lwd = 2, col = 'blue4', cex.axis = 1.3, cex.lab = 1.3)
legend("bottomright", legend = c("Train","Test"), col = c('red4','blue4'),lty = 1)
title(main = "ROC Curve for Patient Mortality (Balanced Random Forest)")
```
